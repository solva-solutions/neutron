...
type PoolReserves struct {
	...
	PriceTakerToMaker github_com_neutron_org_neutron_v11_utils_math.PrecDec `protobuf:"bytes,3,opt,name=price_taker_to_maker,json=priceTakerToMaker,proto3,customtype=github.com/solva-solutions/neutron/v11/utils/math.PrecDec" json:"price_taker_to_maker" yaml:"price_taker_to_maker"` // Deprecated: Do not use.
	...
	MakerPrice            github_com_neutron_org_neutron_v11_utils_math.PrecDec `protobuf:"bytes,5,opt,name=maker_price,json=makerPrice,proto3,customtype=github.com/solva-solutions/neutron/v11/utils/math.PrecDec" json:"maker_price" yaml:"maker_price"`
	DecReservesMakerDenom github_com_neutron_org_neutron_v11_utils_math.PrecDec `protobuf:"bytes,6,opt,name=dec_reserves_maker_denom,json=decReservesMakerDenom,proto3,customtype=github.com/solva-solutions/neutron/v11/utils/math.PrecDec" json:"dec_reserves_maker_denom" yaml:"dec_reserves_maker_denom"`
}
