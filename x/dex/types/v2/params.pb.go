...
type Params struct {
	...
	MaxTrueTakerSpread github_com_neutron_org_neutron_v11_utils_math.PrecDec `protobuf:"bytes,2,opt,name=max_true_taker_spread,json=maxTrueTakerSpread,proto3,customtype=github.com/solva-solutions/neutron/v11/utils/math.PrecDec" json:"max_true_taker_spread" yaml:"max_true_taker_spread"`
}
